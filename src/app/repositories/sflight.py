...
from app.schemas import SflightSchema


class SflightRepository(Repository):
    """SQL запросы для таблицы Sflight."""
    async def get_sflight_by_cities(self, from_city:str, to_city:str)->list[SflightSchema]:
    ...
    def _create_sflight(self, sflight:SflightSchema) -> Sflight:
    ...
    async def create_sflight_single(self, sflight:SflightSchema) -> SflightSchema:
    ...
    async def create_sflight_list(self, sflight_list: list[SflightSchema]) -> list[SflightSchema]:
        """Создание одной записи в таблице Sflight."""
